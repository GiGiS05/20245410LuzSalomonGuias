document.addEventListener("DOMContentLoaded", function() {
    ...
    //Accedemos a cada boton por meido de la API DOM
    ...
    function addEstudiantes() {
        ...
        if (inputCarnet != "" && inputNombre != "" && inputApellidos != ""){
            arrayEstudiantes.push(new Array(
                inputCarnet, inputNombre, inputApellidos
            )
        );
    ...
    function viewEstudiantes(){
        ...
        if (totalEstudiantes > 0){
            ...
            for (let i = 0; i < arrayEstudiantes.length; i++){
                //Accediendo a las posiciones del arrglo
